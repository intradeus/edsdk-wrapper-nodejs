...
// Generate: Option
     ...
     * @enum {number}
     */
     static readonly BatteryQuality: {[label: string]: number} = {"Full":3,"Half":1,"High":2,"Low":0};
    /**
     * @readonly
     * @enum {number}
     */
     ...
     * @enum {number}
     */
     static readonly DCStrobe: {[label: string]: number} = {"Auto":0,"Off":3,"On":1,"SlowSynchro":2};
    /**
     * @readonly
     * @enum {number}
     */
     static readonly DriveMode: {[label: string]: number} = {"ContinuousShooting":1,"HighSpeedContinuous":4,"LowSpeedContinuous":5,"SelfTimer10sec":16,"SelfTimer2sec":17,"SelfTimerContinuous":7,"SilentContinuousShooting":20,"SilentHSContinuous":21,"SilentLSContinuous":22,"SilentSingleShooting":19,"SingleShooting":0,"SingleSilentShooting":6,"SuperHighSpeed14fps":18,"Video":2};
    /**
     * @readonly
     * @enum {number}
     */
     static readonly EvfAFMode: {[label: string]: number} = {"ExpandAFAreaAround":6,"ExpandAFAreaCross":5,"FaceTracking":2,"FlexiZoneMulti":3,"LargeZoneAFHorizontal":7,"LargeZoneAFVertical":8,"OnePointAF":1,"Quick":0,"SpotAF":10,"TrackingAF":9,"ZoneAF":4};
    /**
     * @readonly
     * @enum {number}
     */
     static readonly EvfHistogramStatus: {[label: string]: number} = {"Grayout":2,"Hide":0,"Normal":1};
    /**
     * @readonly
     * @enum {number}
     */
     ...
     * @enum {number}
     */
     static readonly EvfZoom: {[label: string]: number} = {"Fit":1,"x10":10,"x5":5};
    /**
     * @readonly
     * @enum {number}
     */
     static readonly LensBarrelStatus: {[label: string]: number} = {"Inner":0,"Outer":1};
    /**
     * @readonly
     * @enum {number}
     */
     static readonly LensStatus: {[label: string]: number} = {"Attached":1,"NotAttached":0};
    /**
     * @readonly
     * @enum {number}
     */
     ...
     * @enum {number}
     */
     static readonly MirrorUpStatus: {[label: string]: number} = {"Disable":0,"DuringShooting":2,"Enable":1};
    /**
     * @readonly
     * @enum {undefined}
     */
     static readonly MovieQuality: {[label: string]: undefined} = {};
    /**
     * @readonly
     * @enum {number}
     */
     static readonly NoiseReduction: {[label: string]: number} = {"Auto":4,"Off":0,"On1":1,"On2":2,"On3":3};
    /**
     * @readonly
     * @enum {number}
     */
     ...
     * @enum {number}
     */
     static readonly Record: {[label: string]: number} = {"Begin":4,"End":0};
    /**
     * @readonly
     * @enum {number}
     */
     static readonly SaveTo: {[label: string]: number} = {"Both":3,"Camera":1,"Host":2};
    /**
     * @readonly
     * @enum {number}
     */
