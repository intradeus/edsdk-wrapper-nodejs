            ...
            "conditions": [
                ...
                [
                    "OS==\"mac\"",
                    {
                        ...
                        "libraries": [
                          "../third_party/EDSDK/macos/EDSDK/Framework/EDSDK.framework/Versions/A/EDSDK"
                        ],
                        'xcode_settings': {
                        ...
                        "copies": [
                            {
                                "destination": "<(PRODUCT_DIR)",
                                "files": [
                                     "<(module_root_dir)/third_party/EDSDK/macos/EDSDK/Framework/EDSDK.Framework/Versions/A/EDSDK"
                                ]
                            }
                        ]
                    }
